...
public class MiniProjectFarisBackup {
     public static void main(String[] args) {
         Scanner faris = new Scanner(System.in);
         String username,password,tujuan;
         int penumpang;
         ...
         username = faris.nextLine();
            ...
            if (username.equalsIgnoreCase("faris")){
                System.out.print("Masukkan Password Anda :\t");
                password = faris.nextLine();
                    
                if(password.equalsIgnoreCase("polinema")){
                ...
                else if(jenis == 'd')
{
        ...
        else
        {
         System.out.println("Data Yang Anda Tidak Terdeteksi");
            ...
            {
            System.out.println("Maaf, Data Tidak Ditemukan salah");
            }
}
}
