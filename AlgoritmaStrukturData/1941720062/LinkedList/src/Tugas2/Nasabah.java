...
public class Nasabah {
    ...
    public Nasabah(String n, String nm, String add) {
        norek = n;
        nama = nm;
        alamat = add;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        LinkedListNsb data = new LinkedListNsb();
        int menu;
        int submenu;
        try {
            do {
                ...
                if (menu == 1) {
                    ...
                    sc.nextLine();
                    if (submenu == 1) {
                        Nasabah addf = new Nasabah();
                        System.out.print("Masukkan No.Rekening :");
                        addf.norek = sc.nextLine();
                        ...
                        Nasabah add = new Nasabah();
                        System.out.print("Masukkan Index : ");
                        int in = sc.nextInt();
                        sc.nextLine();
                        System.out.print("Masukkan No.Rekening :");
                        add.norek = sc.nextLine();
                        System.out.print("Masukkan Nama : ");
                        ...
                        Nasabah addl = new Nasabah();
                        System.out.print("Masukkan No.Rekening :");
                        addl.norek = sc.nextLine();
                        System.out.print("Masukkan Nama : ");
                    ...
                    if (submenu == 1) {
                        ...
                        System.out.print("Masukkan Index : ");
                        int in = sc.nextInt();
                        System.out.println("Data index ke-" + in + " : " + data.get(in));
                    } else {
                        System.exit(0);
                    }
                } else if (menu == 4) {
